...
class RoutingProtocolImpl : public RoutingProtocol {
    ...
    void ping_message_handler(unsigned short port, Packet *recv_packet,unsigned short size);
    void pong_message_handler(unsigned short port, Packet *recv_packet,unsigned short size);
