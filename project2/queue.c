...
////};
////
////void append(Queue *q, packet *newPacket){
////    PNode* curnode = (PNode*)malloc(sizeof(PNode));
////    curnode->packet = newPacket;
////    curnode->next = NULL;
////    if (q->front==NULL){
////        q->front = curnode;
////    }else if (q->rear==NULL){
...
////}
//
//void append(Queue *q, __uint32_t seq_num, __uint32_t data_index){
//    PNode* curnode = (PNode*)malloc(sizeof(PNode));
//    curnode->data[0] = seq_num;
//    curnode->data[1] = data_index;
//    curnode->next = NULL;
//    if (q->front==NULL){
//        q->front = curnode;
//    }else if (q->rear==NULL){
